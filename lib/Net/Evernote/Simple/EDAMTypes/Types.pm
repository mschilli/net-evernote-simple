...
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::User->mk_accessors( qw( id username email name timezone privilege created updated deleted active shardId attributes accounting ) );
  ...
  while (1) 
  {
    ...
    SWITCH: for($fid)
    {
      ...
      /^15$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{attributes} = new Net::Evernote::Simple::EDAMTypes::UserAttributes();
      ...
      /^16$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{accounting} = new Net::Evernote::Simple::EDAMTypes::Accounting();
  ...
  while (1) 
  {
    ...
    SWITCH: for($fid)
    {
      ...
      /^12$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{applicationData} = new Net::Evernote::Simple::EDAMTypes::LazyMap();
  ...
  while (1) 
  {
    ...
    SWITCH: for($fid)
    {
      ...
      /^3$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{data} = new Net::Evernote::Simple::EDAMTypes::Data();
      ...
      /^9$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{recognition} = new Net::Evernote::Simple::EDAMTypes::Data();
      ...
      /^11$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{attributes} = new Net::Evernote::Simple::EDAMTypes::ResourceAttributes();
        $xfer += $self->{attributes}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
      ...
      /^13$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{alternateData} = new Net::Evernote::Simple::EDAMTypes::Data();
...
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::NoteAttributes->mk_accessors( qw( subjectDate latitude longitude altitude author source sourceURL sourceApplication shareDate placeName contentClass applicationData lastEditedBy ) );
      ...
      /^13$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem41 = undef;
            $elem41 = new Net::Evernote::Simple::EDAMTypes::Resource();
...
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::SavedSearch->mk_accessors( qw( guid name query format updateSequenceNum ) );
...
package Net::Evernote::Simple::EDAMTypes::Ad;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::Ad->mk_accessors( qw( id width height advertiserName imageUrl destinationUrl displaySeconds score image imageMime html displayFrequency openInTrunk ) );
...
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::SharedNotebook->mk_accessors( qw( id userId notebookGuid email notebookModifiable requireLogin serviceCreated serviceUpdated shareKey username ) );
...
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::Notebook->mk_accessors( qw( guid name updateSequenceNum defaultNotebook serviceCreated serviceUpdated publishing published stack sharedNotebookIds sharedNotebooks ) );
  ...
  while (1) 
  {
    ...
    SWITCH: for($fid)
    {
      ...
      /^10$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{publishing} = new Net::Evernote::Simple::EDAMTypes::Publishing();
      ...
      /^14$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem62 = undef;
            $elem62 = new Net::Evernote::Simple::EDAMTypes::SharedNotebook();
...
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::LinkedNotebook->mk_accessors( qw( shareName username shardId shareKey uri guid updateSequenceNum noteStoreUrl webApiUrlPrefix ) );
