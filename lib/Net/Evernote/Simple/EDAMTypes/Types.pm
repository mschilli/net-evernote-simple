...
package Net::Evernote::Simple::EDAMTypes::PrivilegeLevel;
...
package Net::Evernote::Simple::EDAMTypes::QueryFormat;
use constant USER => 1;
use constant SEXP => 2;
package Net::Evernote::Simple::EDAMTypes::NoteSortOrder;
...
package Net::Evernote::Simple::EDAMTypes::PremiumOrderStatus;
use constant NONE => 0;
...
package Net::Evernote::Simple::EDAMTypes::SharedNotebookPrivilegeLevel;
...
package Net::Evernote::Simple::EDAMTypes::SponsoredGroupRole;
use constant GROUP_MEMBER => 1;
use constant GROUP_ADMIN => 2;
use constant GROUP_OWNER => 3;
package Net::Evernote::Simple::EDAMTypes::BusinessUserRole;
use constant ADMIN => 1;
use constant NORMAL => 2;
package Net::Evernote::Simple::EDAMTypes::SharedNotebookInstanceRestrictions;
use constant ONLY_JOINED_OR_PREVIEW => 1;
use constant NO_SHARED_NOTEBOOKS => 2;
package Net::Evernote::Simple::EDAMTypes::ReminderEmailConfig;
use constant DO_NOT_SEND => 1;
use constant SEND_DAILY_EMAIL => 2;
package Net::Evernote::Simple::EDAMTypes::Data;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::Data->mk_accessors( qw( bodyHash size body ) );
...
package Net::Evernote::Simple::EDAMTypes::BusinessUserInfo;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::BusinessUserInfo->mk_accessors( qw( businessId businessName role email ) );
...
package Net::Evernote::Simple::EDAMTypes::PremiumInfo;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::PremiumInfo->mk_accessors( qw( currentTime premium premiumRecurring premiumExpirationDate premiumExtendable premiumPending premiumCancellationPending canPurchaseUploadAllowance sponsoredGroupName sponsoredGroupRole premiumUpgradable ) );
...
package Net::Evernote::Simple::EDAMTypes::User;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::User->mk_accessors( qw( id username email name timezone privilege created updated deleted active shardId attributes accounting premiumInfo businessUserInfo ) );
  ...
  while (1) 
  {
    ...
    SWITCH: for($fid)
    {
      ...
      /^15$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{attributes} = Net::Evernote::Simple::EDAMTypes::UserAttributes->new();
      ...
      /^16$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{accounting} = Net::Evernote::Simple::EDAMTypes::Accounting->new();
      ...
      /^17$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{premiumInfo} = Net::Evernote::Simple::EDAMTypes::PremiumInfo->new();
      ...
      /^18$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{businessUserInfo} = Net::Evernote::Simple::EDAMTypes::BusinessUserInfo->new();
...
package Net::Evernote::Simple::EDAMTypes::Tag;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::Tag->mk_accessors( qw( guid name parentGuid updateSequenceNum ) );
...
package Net::Evernote::Simple::EDAMTypes::LazyMap;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::LazyMap->mk_accessors( qw( keysOnly fullMap ) );
...
package Net::Evernote::Simple::EDAMTypes::ResourceAttributes;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::ResourceAttributes->mk_accessors( qw( sourceURL timestamp latitude longitude altitude cameraMake cameraModel clientWillIndex recoType fileName attachment applicationData ) );
  ...
  while (1) 
  {
    ...
    SWITCH: for($fid)
    {
      ...
      /^12$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{applicationData} = Net::Evernote::Simple::EDAMTypes::LazyMap->new();
...
package Net::Evernote::Simple::EDAMTypes::Resource;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::Resource->mk_accessors( qw( guid noteGuid data mime width height duration active recognition attributes updateSequenceNum alternateData ) );
  ...
  while (1) 
  {
    ...
    SWITCH: for($fid)
    {
      ...
      /^3$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{data} = Net::Evernote::Simple::EDAMTypes::Data->new();
      ...
      /^9$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{recognition} = Net::Evernote::Simple::EDAMTypes::Data->new();
      ...
      /^11$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{attributes} = Net::Evernote::Simple::EDAMTypes::ResourceAttributes->new();
        $xfer += $self->{attributes}->read($input);
      } else {
        $xfer += $input->skip($ftype);
      }
      ...
      /^13$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{alternateData} = Net::Evernote::Simple::EDAMTypes::Data->new();
...
package Net::Evernote::Simple::EDAMTypes::NoteAttributes;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::NoteAttributes->mk_accessors( qw( subjectDate latitude longitude altitude author source sourceURL sourceApplication shareDate reminderOrder reminderDoneTime reminderTime placeName contentClass applicationData lastEditedBy classifications creatorId lastEditorId ) );
...
package Net::Evernote::Simple::EDAMTypes::Note;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::Note->mk_accessors( qw( guid title content contentHash contentLength created updated deleted active updateSequenceNum notebookGuid tagGuids resources attributes tagNames ) );
      ...
      /^13$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem50 = undef;
            $elem50 = Net::Evernote::Simple::EDAMTypes::Resource->new();
...
package Net::Evernote::Simple::EDAMTypes::Publishing;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::Publishing->mk_accessors( qw( uri order ascending publicDescription ) );
...
package Net::Evernote::Simple::EDAMTypes::BusinessNotebook;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::BusinessNotebook->mk_accessors( qw( notebookDescription privilege recommended ) );
...
package Net::Evernote::Simple::EDAMTypes::SavedSearchScope;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::SavedSearchScope->mk_accessors( qw( includeAccount includePersonalLinkedNotebooks includeBusinessLinkedNotebooks ) );
...
package Net::Evernote::Simple::EDAMTypes::SavedSearch;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::SavedSearch->mk_accessors( qw( guid name query format updateSequenceNum scope ) );
  ...
  while (1) 
  {
    ...
    SWITCH: for($fid)
    {
      ...
      /^6$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{scope} = Net::Evernote::Simple::EDAMTypes::SavedSearchScope->new();
...
package Net::Evernote::Simple::EDAMTypes::SharedNotebookRecipientSettings;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::SharedNotebookRecipientSettings->mk_accessors( qw( reminderNotifyEmail reminderNotifyInApp ) );
...
package Net::Evernote::Simple::EDAMTypes::SharedNotebook;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::SharedNotebook->mk_accessors( qw( id userId notebookGuid email notebookModifiable requireLogin serviceCreated serviceUpdated shareKey username privilege allowPreview recipientSettings ) );
...
package Net::Evernote::Simple::EDAMTypes::NotebookRestrictions;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::NotebookRestrictions->mk_accessors( qw( noReadNotes noCreateNotes noUpdateNotes noExpungeNotes noShareNotes noEmailNotes noSendMessageToRecipients noUpdateNotebook noExpungeNotebook noSetDefaultNotebook noSetNotebookStack noPublishToPublic noPublishToBusinessLibrary noCreateTags noUpdateTags noExpungeTags noSetParentTag noCreateSharedNotebooks updateWhichSharedNotebookRestrictions expungeWhichSharedNotebookRestrictions ) );
...
package Net::Evernote::Simple::EDAMTypes::Notebook;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::Notebook->mk_accessors( qw( guid name updateSequenceNum defaultNotebook serviceCreated serviceUpdated publishing published stack sharedNotebookIds sharedNotebooks businessNotebook contact restrictions ) );
  ...
  while (1) 
  {
    ...
    SWITCH: for($fid)
    {
      ...
      /^10$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{publishing} = Net::Evernote::Simple::EDAMTypes::Publishing->new();
      ...
      /^14$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem71 = undef;
            $elem71 = Net::Evernote::Simple::EDAMTypes::SharedNotebook->new();
      ...
      last; };
      /^15$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{businessNotebook} = Net::Evernote::Simple::EDAMTypes::BusinessNotebook->new();
      ...
      last; };
      /^16$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{contact} = Net::Evernote::Simple::EDAMTypes::User->new();
      ...
      last; };
      /^17$/ && do{      if ($ftype == TType::STRUCT) {
        $self->{restrictions} = Net::Evernote::Simple::EDAMTypes::NotebookRestrictions->new();
...
package Net::Evernote::Simple::EDAMTypes::LinkedNotebook;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::LinkedNotebook->mk_accessors( qw( shareName username shardId shareKey uri guid updateSequenceNum noteStoreUrl webApiUrlPrefix stack businessId ) );
...
package Net::Evernote::Simple::EDAMTypes::NotebookDescriptor;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMTypes::NotebookDescriptor->mk_accessors( qw( guid notebookDisplayName contactName hasSharedNotebook joinedUserCount ) );
