...
package Net::Evernote::Simple::EDAMErrors::Net::Evernote::Simple::EDAMErrorCode;
...
package Net::Evernote::Simple::EDAMErrors::Net::Evernote::Simple::EDAMUserException;
use base qw(Thrift::TException);
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMErrors::Net::Evernote::Simple::EDAMUserException->mk_accessors( qw( errorCode parameter ) );
...
sub getName {
  return 'Net::Evernote::Simple::EDAMUserException';
}
...
sub write {
  my ($self, $output) = @_;
  my $xfer   = 0;
  $xfer += $output->writeStructBegin('Net::Evernote::Simple::EDAMUserException');
...
package Net::Evernote::Simple::EDAMErrors::Net::Evernote::Simple::EDAMSystemException;
use base qw(Thrift::TException);
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMErrors::Net::Evernote::Simple::EDAMSystemException->mk_accessors( qw( errorCode message rateLimitDuration ) );
...
sub getName {
  return 'Net::Evernote::Simple::EDAMSystemException';
}
...
sub write {
  my ($self, $output) = @_;
  my $xfer   = 0;
  $xfer += $output->writeStructBegin('Net::Evernote::Simple::EDAMSystemException');
  if (defined $self->{errorCode}) {
    $xfer += $output->writeFieldBegin('errorCode', TType::I32, 1);
    $xfer += $output->writeI32($self->{errorCode});
    $xfer += $output->writeFieldEnd();
...
package Net::Evernote::Simple::EDAMErrors::Net::Evernote::Simple::EDAMNotFoundException;
use base qw(Thrift::TException);
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMErrors::Net::Evernote::Simple::EDAMNotFoundException->mk_accessors( qw( identifier key ) );
...
sub getName {
  return 'Net::Evernote::Simple::EDAMNotFoundException';
}
...
sub write {
  my ($self, $output) = @_;
  my $xfer   = 0;
  $xfer += $output->writeStructBegin('Net::Evernote::Simple::EDAMNotFoundException');
