...
package Net::Evernote::Simple::EDAMNoteStore::SyncState;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMNoteStore::SyncState->mk_accessors( qw( currentTime fullSyncBefore updateCount uploaded ) );
...
package Net::Evernote::Simple::EDAMNoteStore::SyncChunk;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMNoteStore::SyncChunk->mk_accessors( qw( currentTime chunkHighUSN updateCount notes notebooks tags searches resources expungedNotes expungedNotebooks expungedTags expungedSearches linkedNotebooks expungedLinkedNotebooks ) );
...
package Net::Evernote::Simple::EDAMNoteStore::NoteFilter;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMNoteStore::NoteFilter->mk_accessors( qw( order ascending words notebookGuid tagGuids timeZone inactive emphasized ) );
...
package Net::Evernote::Simple::EDAMNoteStore::NoteList;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMNoteStore::NoteList->mk_accessors( qw( startIndex totalNotes notes stoppedWords searchedWords updateCount ) );
...
package Net::Evernote::Simple::EDAMNoteStore::NoteMetadata;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMNoteStore::NoteMetadata->mk_accessors( qw( guid title contentLength created updated deleted updateSequenceNum notebookGuid tagGuids attributes largestResourceMime largestResourceSize ) );
...
package Net::Evernote::Simple::EDAMNoteStore::NotesMetadataList;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMNoteStore::NotesMetadataList->mk_accessors( qw( startIndex totalNotes notes stoppedWords searchedWords updateCount ) );
...
package Net::Evernote::Simple::EDAMNoteStore::NotesMetadataResultSpec;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMNoteStore::NotesMetadataResultSpec->mk_accessors( qw( includeTitle includeContentLength includeCreated includeUpdated includeDeleted includeUpdateSequenceNum includeNotebookGuid includeTagGuids includeAttributes includeLargestResourceMime includeLargestResourceSize ) );
...
package Net::Evernote::Simple::EDAMNoteStore::NoteCollectionCounts;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMNoteStore::NoteCollectionCounts->mk_accessors( qw( notebookCounts tagCounts trashCount ) );
...
package Net::Evernote::Simple::EDAMNoteStore::NoteEmailParameters;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMNoteStore::NoteEmailParameters->mk_accessors( qw( guid note toAddresses ccAddresses subject message ) );
...
package Net::Evernote::Simple::EDAMNoteStore::NoteVersionId;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMNoteStore::NoteVersionId->mk_accessors( qw( updateSequenceNum updated saved title ) );
...
package Net::Evernote::Simple::EDAMNoteStore::ClientUsageMetrics;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMNoteStore::ClientUsageMetrics->mk_accessors( qw( sessions ) );
...
sub read {
  ...
  while (1) 
  {
    ...
    {
      /^1$/ && do{      if ($ftype == TType::I32) {
        $xfer += $input->readI32(\$self->{sessions});
      } else {
        $xfer += $input->skip($ftype);
      }
      last; };
...
sub write {
  ...
  if (defined $self->{sessions}) {
    ...
    $xfer += $output->writeI32($self->{sessions});
    $xfer += $output->writeFieldEnd();
  }
  $xfer += $output->writeFieldStop();
  $xfer += $output->writeStructEnd();
...
package Net::Evernote::Simple::EDAMNoteStore::RelatedQuery;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMNoteStore::RelatedQuery->mk_accessors( qw( noteGuid plainText filter referenceUri ) );
...
package Net::Evernote::Simple::EDAMNoteStore::RelatedResult;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMNoteStore::RelatedResult->mk_accessors( qw( notes notebooks tags containingNotebooks ) );
      ...
      /^1$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem170 = undef;
            $elem170 = Net::Evernote::Simple::EDAMTypes::Note->new();
      ...
      /^2$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem176 = undef;
            $elem176 = Net::Evernote::Simple::EDAMTypes::Notebook->new();
      ...
      /^3$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem182 = undef;
            $elem182 = Net::Evernote::Simple::EDAMTypes::Tag->new();
      ...
      /^4$/ && do{      if ($ftype == TType::LIST) {
        {
          ...
          {
            my $elem188 = undef;
            $elem188 = Net::Evernote::Simple::EDAMTypes::NotebookDescriptor->new();
...
package Net::Evernote::Simple::EDAMNoteStore::RelatedResultSpec;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMNoteStore::RelatedResultSpec->mk_accessors( qw( maxNotes maxNotebooks maxTags writableNotebooksOnly includeContainingNotebooks ) );
