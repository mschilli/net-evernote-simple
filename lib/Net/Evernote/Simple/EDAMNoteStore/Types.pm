...
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMNoteStore::NoteFilter->mk_accessors( qw( order ascending words notebookGuid tagGuids timeZone inactive ) );
...
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMNoteStore::NoteMetadata->mk_accessors( qw( guid title contentLength created updated updateSequenceNum notebookGuid tagGuids attributes largestResourceMime largestResourceSize ) );
...
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMNoteStore::NotesMetadataResultSpec->mk_accessors( qw( includeTitle includeContentLength includeCreated includeUpdated includeUpdateSequenceNum includeNotebookGuid includeTagGuids includeAttributes includeLargestResourceMime includeLargestResourceSize ) );
...
package Net::Evernote::Simple::EDAMNoteStore::AdImpressions;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMNoteStore::AdImpressions->mk_accessors( qw( adId impressionCount impressionTime ) );
...
package Net::Evernote::Simple::EDAMNoteStore::AdParameters;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMNoteStore::AdParameters->mk_accessors( qw( clientLanguage impressions supportHtml clientProperties ) );
