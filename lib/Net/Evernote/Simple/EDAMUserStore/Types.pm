...
Net::Evernote::Simple::EDAMUserStore::PublicUserInfo->mk_accessors( qw( userId shardId privilege username noteStoreUrl webApiUrlPrefix ) );
...
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMUserStore::AuthenticationResult->mk_accessors( qw( currentTime authenticationToken expiration user publicUserInfo noteStoreUrl webApiUrlPrefix secondFactorRequired secondFactorDeliveryHint ) );
