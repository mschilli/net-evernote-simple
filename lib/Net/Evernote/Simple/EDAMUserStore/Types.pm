...
package Net::Evernote::Simple::EDAMUserStore::SponsoredGroupRole;
use constant GROUP_MEMBER => 1;
use constant GROUP_ADMIN => 2;
use constant GROUP_OWNER => 3;
package Net::Evernote::Simple::EDAMUserStore::PublicUserInfo;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMUserStore::PublicUserInfo->mk_accessors( qw( userId shardId privilege username noteStoreUrl ) );
...
package Net::Evernote::Simple::EDAMUserStore::PremiumInfo;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMUserStore::PremiumInfo->mk_accessors( qw( currentTime premium premiumRecurring premiumExpirationDate premiumExtendable premiumPending premiumCancellationPending canPurchaseUploadAllowance sponsoredGroupName sponsoredGroupRole ) );
...
package Net::Evernote::Simple::EDAMUserStore::AuthenticationResult;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMUserStore::AuthenticationResult->mk_accessors( qw( currentTime authenticationToken expiration user publicUserInfo noteStoreUrl webApiUrlPrefix ) );
...
package Net::Evernote::Simple::EDAMUserStore::BootstrapSettings;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMUserStore::BootstrapSettings->mk_accessors( qw( serviceHost marketingUrl supportUrl accountEmailDomain enableFacebookSharing enableGiftSubscriptions enableSupportTickets enableSharedNotebooks enableSingleNoteSharing enableSponsoredAccounts enableTwitterSharing ) );
...
package Net::Evernote::Simple::EDAMUserStore::BootstrapProfile;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMUserStore::BootstrapProfile->mk_accessors( qw( name settings ) );
...
package Net::Evernote::Simple::EDAMUserStore::BootstrapInfo;
use base qw(Class::Accessor);
Net::Evernote::Simple::EDAMUserStore::BootstrapInfo->mk_accessors( qw( profiles ) );
